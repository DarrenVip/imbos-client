 ...
 *
 */
public class ContactSelectActivity extends SkinActivity {
    ...
    private AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
    	...
    	public void onItemClick(AdapterView<?> adapterView, View arg1, int position,
    		...
    		if("000".equals(item.uid)|| "001".equals(item.uid))
    			return;
    		startActivity(new Intent(ContactSelectActivity.this, ChatActivity.class)
		...
		SyncService.start(new SyncTask()
				.setSyncListener(new SimpleSyncListener(this,true){
					...
					public void onSuccess() {
						DbManager.updateTable(Constants.MENTHOD.FRIENDS);
						loadFriends();
						super.onSuccess();
    ...
    public void loadFriends(){
    	...
    	while (cursor.moveToNext()) {
    		...
    		String alias = cursor.getString(7);
    		if(StringUtil.isEmpty(alias))
    			contact.pingy =StringUtil.toString(cursor.getString(6));
    		else
    			contact.pingy =StringUtil.toString(cursor.getString(8));
    		data.add(contact);
		}
    	cursor.close();
